...
export default function AssignmentBody({ assignment }) {
  ...
  return (
    <tr className='border-b border-slate-200/30 w-full grid grid-cols-4 gap-x-10'>
      <RowData dataText={title} />
      <RowData dataText={video_title} />
      <RowData dataText={totalMark} last='justify-self-end' />

      <td className='table-td flex gap-x-2  justify-self-end'>
        <svg
          fill='none'
          viewBox='0 0 24 24'
          strokeWidth='1.5'
